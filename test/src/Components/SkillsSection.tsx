    ...
    <div className="App py-6 px-4 bg-[#1f1f1f] rounded-md max-h-[523px] overflow-auto">
      ...
      <ul className="grid gap-[12px]">
        {skills.map((skill: Skill, index: number) => (
          <li
            key={index}
            className="flex flex-col bg-[#2D2D2D] px-2 rounded-md py-[12px] pr-4 border border-[#494949]"
          >
            ...
            {isEditing && currentIndex === index && (
              <div className="mt-2">
                <div className="bg-[#2D2D2D] px-[16px] py-[12px] rounded-md">
                  <p className="border-b-2 border-gray-600 text-4 font-medium pb-[8px]">
                    Edit a skill
                  </p>
                  <div className="flex gap-5 items-center">
                    <div className="w-[60%] sm:w-[80%]">
                      <Select
                        ...
                        className="w-full bg-transparent border border-[#494949] px-2 py-[1px] rounded-md outline-none text-4"
                      />
                    ...
                    <div className="w-[35%] sm:w-[20%]">
                      <input
                        ...
                        className="w-full bg-transparent border border-[#494949] px-2 py-2 rounded-md outline-none"
                      />
                  ...
                  <input
                    ...
                    className="bg-transparent w-[100%] border border-[#494949] rounded-md px-2 py-2 outline-none mt-0"
                  />

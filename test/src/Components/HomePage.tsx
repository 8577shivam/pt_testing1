        ...
        <div className="h-full flex justify-center items-center">
          <div className="h-full flex flex-col justify-center w-fit">
            ...
            <div className="flex items-center gap-4">
              ...
              <button className="h-[48px] flex items-center gap-4 bg-gradient-to-r from-[#986EEB] via-[#FD68B3] to-[#FDB786] text-white border-none text-base font-bold px-3 py-2 rounded-lg ease-in-out duration-300 hover:opacity-80" onClick={handleStart}>
                Start
